...
public class TouchRotate : MonoBehaviour {
	...
	public Vector3 prevMousePostion;
...
//			float deltaX = v3.x - prevMousePostion.x;
//			float deltaY = v3.y - prevMousePostion.y;
//			float x = deltaX * xSpeed * Time.deltaTime;
//			float y =deltaY * ySpeed * Time.deltaTime;
