...
//		}
	...
	void OnMouseDown(){
		...
		if (threeDObject == null) {
			...
			ScanSceneController.instant.SetState ("menuvideo", new Hashtable{{"item",this}}, false);
		} else {

			ScanSceneController.instant.SetState ("menuobject", new Hashtable{{"item",this}}, false);
